...
augroup MaterialOverrides
	...
	autocmd User PlugLoaded ++nested exec 'hi LineNr guifg=#617b87 guibg=NONE'
	...
	" Git
	autocmd User PlugLoaded ++nested exec 'hi DiffAdd guibg=NONE'
	autocmd User PlugLoaded ++nested exec 'hi DiffChange guibg=NONE'
	autocmd User PlugLoaded ++nested exec 'hi DiffDelete guibg=NONE'
augroup end
